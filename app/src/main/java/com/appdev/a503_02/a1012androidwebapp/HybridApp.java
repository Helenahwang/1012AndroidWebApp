package com.appdev.a503_02.a1012androidwebapp;
...
public class HybridApp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //url 로딩
        webView.loadUrl("http://192.168.0.230:8080/mobileweb/hybridapp");

        //버튼의 클릭 이벤트 처리
        final Button sendmsg1 = (Button)findViewById(R.id.sendmsg);
